...
/**
 * 本地配置管理类
 * @property-read string $type 下载器类型
 * @property-read string $host 地址与端口
 * @property-read string $endpoint 接入点
 * @property-read string $username 用户名
 * @property-read string $password 密码
 * @property-read string $debug 调试开关
 */
class Config implements ArrayAccess
{
    ...
    {
        return rtrim($this->get('host', ''), '/') . $this->get('endpoint', '');
    }
